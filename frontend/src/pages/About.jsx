...
const About = () => {
  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
            <div style={{ padding: '2rem', backgroundColor: '#f1f5f9', borderRadius: '16px' }}>
              ...
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Quality Education</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>Committed to providing the highest standard of educational support through verified, experienced tutors.</p>
            </div>
            <div style={{ padding: '2rem', backgroundColor: '#f1f5f9', borderRadius: '16px' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🌍</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Accessibility</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>Making quality education accessible to students from all backgrounds and locations.</p>
            </div>
            <div style={{ padding: '2rem', backgroundColor: '#f1f5f9', borderRadius: '16px' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🚀</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Innovation</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>Leveraging cutting-edge technology to create smarter, more effective learning experiences.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🤖</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Smart Technology</h3>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>✅</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Verified Tutors</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>⚡</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Real-time Platform</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🎨</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Personalized Learning</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🔒</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Trust & Safety</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>📊</div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: '600', color: '#1e293b', marginBottom: '1rem' }}>Progress Tracking</h3>
              <p style={{ color: '#64748b', lineHeight: '1.6', fontSize: '1rem' }}>
      ...
      <section style={{ padding: '4rem 2rem', backgroundColor: '#1e293b', color: 'white' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '3rem' }}>What Our Students Say</h2>
              ...
              {testimonials.map((testimonial, index) => {
                ...
                return (
                  <div key={testimonial._id} style={{ 
                    ...
                    <div style={{ fontSize: '1.5rem', marginBottom: '1rem', display: 'flex', justifyContent: 'center' }}>
                      {[...Array(5)].map((_, i) => (
                        <span key={i} style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
                      ...
                      <div>
                        <p style={{ margin: '0', fontWeight: '600', fontSize: '1rem' }}>{testimonial.name}</p>
      ...
      <section style={{ padding: '4rem 2rem', backgroundColor: 'white' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#1e293b', marginBottom: '1rem' }}>Get in Touch</h2>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '3rem', flexWrap: 'wrap' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1e293b', marginBottom: '0.5rem' }}>Email</h3>
              <p style={{ color: '#64748b', fontSize: '1rem' }}>support@tuitix.com</p>
            </div>
            
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>📞</div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1e293b', marginBottom: '0.5rem' }}>Phone</h3>
              <p style={{ color: '#64748b', fontSize: '1rem' }}>+1 (555) 123-4567</p>
            </div>
            
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>🕒</div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1e293b', marginBottom: '0.5rem' }}>Hours</h3>
              <p style={{ color: '#64748b', fontSize: '1rem' }}>Mon-Fri: 9AM-6PM</p>
            </div>
          </div>
        </div>
      </section>
